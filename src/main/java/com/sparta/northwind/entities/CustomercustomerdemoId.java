...
@Embeddable
public class CustomercustomerdemoId extends RepresentationModel<Customercustomerdemo>  implements Serializable {
	private static final long serialVersionUID = -7312002673112826201L;
